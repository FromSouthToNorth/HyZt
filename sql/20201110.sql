...
-- 二级菜单
insert into sys_menu values('2001', '博客管理', '1',   '1', 'blog',       'system/blog/index',        1, 0, 'C', '0', '0', 'blog:blog:list',          'education',     'admin', sysdate(), '', null, '博客管理菜单');
insert into sys_menu values('2002', '博客类型', '1',   '2', 'type',       'system/type/index',        1, 0, 'C', '0', '0', 'blog:type:list',          'blog-type',     'admin', sysdate(), '', null, '类型管理菜单');
insert into sys_menu values('2003', '博客标签', '1',   '3', 'tag',        'system/tag/index',         1, 0, 'C', '0', '0', 'blog:tag:list',           'blog-tag',      'admin', sysdate(), '', null, '标签管理菜单');
insert into sys_menu values('2004', '博客评论', '1',   '4', 'comment',    'system/comment/index',     1, 0, 'C', '0', '0', 'blog:comment:list',       'blog-comment',  'admin', sysdate(), '', null, '评论管理菜单');
insert into sys_menu values('100',  '用户管理', '1',   '5', 'user',       'system/user/index',        1, 0, 'C', '0', '0', 'system:user:list',        'user',          'admin', sysdate(), '', null, '用户管理菜单');
insert into sys_menu values('101',  '角色管理', '1',   '6', 'role',       'system/role/index',        1, 0, 'C', '0', '0', 'system:role:list',        'peoples',       'admin', sysdate(), '', null, '角色管理菜单');
insert into sys_menu values('102',  '菜单管理', '1',   '7', 'menu',       'system/menu/index',        1, 0, 'C', '0', '0', 'system:menu:list',        'tree-table',    'admin', sysdate(), '', null, '菜单管理菜单');
insert into sys_menu values('103',  '部门管理', '1',   '8', 'dept',       'system/dept/index',        1, 0, 'C', '0', '0', 'system:dept:list',        'tree',          'admin', sysdate(), '', null, '部门管理菜单');
insert into sys_menu values('104',  '岗位管理', '1',   '9', 'post',       'system/post/index',        1, 0, 'C', '0', '0', 'system:post:list',        'post',          'admin', sysdate(), '', null, '岗位管理菜单');
insert into sys_menu values('105',  '字典管理', '1',   '10', 'dict',      'system/dict/index',        1, 0, 'C', '0', '0', 'system:dict:list',        'dict',          'admin', sysdate(), '', null, '字典管理菜单');
insert into sys_menu values('106',  '参数设置', '1',   '11', 'config',    'system/config/index',      1, 0, 'C', '0', '0', 'system:config:list',      'edit',          'admin', sysdate(), '', null, '参数设置菜单');
insert into sys_menu values('107',  '通知公告', '1',   '12', 'notice',    'system/notice/index',      1, 0, 'C', '0', '0', 'system:notice:list',      'message',       'admin', sysdate(), '', null, '通知公告菜单');
insert into sys_menu values('108',  '日志管理', '1',   '13', 'log',       'system/log/index',         1, 0, 'M', '0', '0', '',                        'log',           'admin', sysdate(), '', null, '日志管理菜单');
...
-- 博客管理按钮
insert into sys_menu values('2005', '博客查询', '2001', '1', '', null , 1, 0, 'F', '0', '0', 'system:blog:query',     '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('2006', '博客新增', '2001', '2', '', null , 1, 0, 'F', '0', '0', 'system:blog:add',       '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('2008', '博客修改', '2001', '3', '', null , 1, 0, 'F', '0', '0', 'system:blog:edit',      '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('2009', '博客删除', '2001', '4', '', null , 1, 0, 'F', '0', '0', 'system:blog:remove',    '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('2010', '类型查询', '2002', '1', '', null , 1, 0, 'F', '0', '0', 'system:type:query',     '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('2011', '类型新增', '2002', '2', '', null , 1, 0, 'F', '0', '0', 'system:type:add',       '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('2012', '类型修改', '2002', '3', '', null , 1, 0, 'F', '0', '0', 'system:type:edit',      '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('2013', '类型删除', '2002', '4', '', null , 1, 0, 'F', '0', '0', 'system:type:remove',    '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('2014', '评论查询', '2004', '1', '', null , 1, 0, 'F', '0', '0', 'system:comment:query',  '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('2015', '评论删除', '2004', '2', '', null , 1, 0, 'F', '0', '0', 'system:comment:remove', '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('2016', '标签查询', '2003', '1', '', null , 1, 0, 'F', '0', '0', 'system:tag:query',      '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('2017', '新增标签', '2003', '2', '', null , 1, 0, 'F', '0', '0', 'system:tag:add',        '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('2018', '标签修改', '2003', '3', '', null , 1, 0, 'F', '0', '0', 'system:tag:edit',       '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('2019', '标签删除', '2003', '4', '', null , 1, 0, 'F', '0', '0', 'system:tag:remove',     '#', 'admin', sysdate(), '', null, '');
